...
import yunstudio2015.android.yunmeet.activityz.LaunchActivityActivity;
import yunstudio2015.android.yunmeet.activityz.LaunchChatTopicActivity;

/**
 * Created by Ulrich on 1/31/2016.
 */
public class LaunchActivityImageAdapter extends RecyclerView.Adapter<LaunchActivityImageAdapter.ViewHolder>{
    ...
    public LaunchActivityImageAdapter(Context context, ArrayList<String> data) {
        this.data = data;
    ...
    @Override
    public LaunchActivityImageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final LaunchActivityImageAdapter.ViewHolder holder, final int position) {
...
//                holder.itemView.setVisibility(View.GONE);
    ...
    private void startActivityFromPosition(int position) {
        ...
        Intent intent = new Intent(context, BrowseSelectedPicturesActivity.class);
    ...
    private void removeAt(int position) {
        ...
        ((LaunchActivityActivity) context).redrawRecyclerview(position);
//        notifyItemRangeChanged(position, data.size());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            rel_background = (RelativeLayout) itemView.findViewById(R.id.rel_background);
