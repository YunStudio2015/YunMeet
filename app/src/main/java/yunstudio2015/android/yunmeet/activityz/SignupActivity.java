    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etPhoneNumber.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (phoneNumber != null && isInputRight(0, phoneNumber) ) {
                    btnSendCode.setBackgroundColor(getColor(R.color.btn_background));
                } else {
        ...
        btnSendCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phoneNumber == null || !isInputRight(0, phoneNumber)) {
                    Toast.makeText(SignupActivity.this, R.string.wrong_phone_number, Toast.LENGTH_SHORT).show();
                } else {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phoneNumber == null || !isInputRight(0, phoneNumber)) {
                    ...
                    Toast.makeText(SignupActivity.this, R.string.wrong_password, Toast.LENGTH_SHORT).show();
                } else if (verificationCode == null || verificationCode.length() != 6) {
                    Toast.makeText(SignupActivity.this, R.string.wrong_verification_code, Toast.LENGTH_SHORT).show();
                } else {
                    //这里写请求服务器注册新账号的逻辑
