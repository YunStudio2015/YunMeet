...
public class ImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView iv = (ImageView) rootview.findViewById(R.id.imageview); // 获取fragment里面的imageview并设置image
        setImage(iv, mParam1);
        iv.setImageResource(R.drawable.signup_background);
        /* double tap should allow me to zoom, and to un zoom */
        return rootview;
    }

    private void setImage(ImageView iv, String imgPath) {
