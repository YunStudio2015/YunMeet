...
import com.adhamenaya.androidmosaiclayout.views.Block;
...
import com.adhamenaya.androidmosaiclayout.views.Cell;
import com.adhamenaya.androidmosaiclayout.views.CellView;

import java.util.ArrayList;
import java.util.List;

public class AbMosaicLayout extends NestedScrollView {
	...
	private List<BLOCK_PATTERN[]> patternsList = new ArrayList<BLOCK_PATTERN[]>();
	 ...
	 */
	public AbMosaicLayout(Context context) {
		super(context);
	...
	public AbMosaicLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		if (frameLayout == null) {
			frameLayout = new FrameLayout(mContext);
	...
	public AbMosaicLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	private void display(Context cx) {
		...
		// compute the position of the cell according to the pattern
